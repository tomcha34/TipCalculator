package com.android.training.tipcalculator
...
import com.android.training.tipcalculator.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun calculateTip() {
        ...
        //Get the "other" amount the user would like for a tip %.
        var stringInOtherField = binding.otherAmount.text.toString()
        if (stringInOtherField.isEmpty()) {
            stringInOtherField = "0"
        }

        // Convert to Double for calculations.
        val otherTip = stringInOtherField.toDouble()
